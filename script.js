...
function showDetails(metric) {
    ...
    if (metric === 'Neutrality') {
        detailsTitle.textContent = 'Neutrality Details';
        detailsText.textContent = 'This section provides insight into detected biases. High scores indicate low bias in the data.';
